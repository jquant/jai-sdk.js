...
import { JAIDatabaseTypeEnum, JAIModeEnum } from './src/estructures/enums';
...
async function main3() {
  ...
  const res  = await jai.setup('teste_iago', df, JAIDatabaseTypeEnum.SUPERVISED, 16384, 1, '', 1, {overwrite: false});
  console.log(res);
}
